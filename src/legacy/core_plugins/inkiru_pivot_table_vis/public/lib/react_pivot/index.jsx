...
module.exports = createReactClass({
  ...
  componentWillReceiveProps: function(newProps) {
    ...
    if(newProps.activeDimensions !== this.props.activeDimensions) {
      var allDimensions = newProps.dimensions
      var activeDimensions =  _.filter(newProps.activeDimensions, function (title) {
        return _.find(allDimensions, function(col) {
          return col.title === title
        })
      })

      this.setDimensions(activeDimensions);
    }
  },
